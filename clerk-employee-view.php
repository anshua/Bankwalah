...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Name*</td>
		<td style=\"width:70%;\"><a href=\"clerk-employee-view.php?id=".$row["EmpID"]."\">".$row["EmpName"]."</a></td>
	</tr>
	<tr>
		<td>Father's Name*</td>
	...
	<tr>
		<td>Branch ID*</td>
		<td style=\"width:70%;\"><a href=\"clerk-branch-view.php?id=".$row["EmpBrID"]."\">".$row["EmpBrID"]." (".$row["BrLoc"].")</a></td>
	</tr>
	<tr>
		<td>Role*</td>
...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printemprecord')\">PRINT EMPLOYEE RECORD</button>";
	}
}
else {
