...
if (isset($_POST["submitnew"]) || isset($_POST["submitedit"]) || isset($_POST["submitconf"]) || ($_GET["id"] == $my_ID)) {
...
<table class=\"table table-striped\">
	...
	<tr>
		...
		<td style=\"width:70%;\"><a href=\"admin-customer-view.php?id=".$row["TrCustID"]."\">".$row["CustName"]."</a></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style=\"width:70%;\"><a href=\"admin-employee-view.php?id=".$row["TrEmpID"]."\">".$row["TrEmpID"]."</a></td>
	</tr>
	<tr>
...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printtransrecord')\">PRINT TRANSACTION RECEIPT</button><a href=\"admin-trans-edit.php?id=".$row["TrID"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">EDIT AND UPDATE BALANCE</button></a>
<a href=\"admin-trans-deleted.php?id=".$row["TrID"]."&name=".$row["CustName"]."&cid=".$row["TrCustID"]."&tramount=".$row["TrAmount"]."\"><button onclick=\"alertdeleteFunction()\" type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DELETE PERMANENTLY AND UPDATE BALANCE</button></a>";
	}
}
else {
