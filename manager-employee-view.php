...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Name*</td>
		<td style=\"width:70%;\"><a href=\"manager-employee-view.php?id=".$row["EmpID"]."\">".$row["EmpName"]."</a></td>
	</tr>
	<tr>
		<td>Father's Name*</td>
	...
	<tr>
		<td>Branch ID*</td>
		<td style=\"width:70%;\"><a href=\"manager-branch-view.php?id=".$row["EmpBrID"]."\">".$row["EmpBrID"]." (".$row["BrLoc"].")</a></td>
	</tr>
	<tr>
		<td>Role*</td>
...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printemprecord')\">PRINT EMPLOYEE RECORD</button><a href=\"manager-employee-edit.php?id=".$row["EmpID"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">EDIT</button></a>
<a href=\"manager-employee-deleted.php?id=".$row["EmpID"]."&name=".$row["EmpName"]."&fname=".$row["EmpFName"]."\"><button onclick=\"alertdeleteFunction()\" type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DELETE PERMANENTLY</button></a>";
	}
}
else {
