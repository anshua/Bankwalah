...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printbranchrecord')\">PRINT BRANCH RECORD</button><a href=\"admin-branch-edit.php?id=".$row["BrID"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">EDIT</button></a>
<a href=\"admin-branch-deleted.php?id=".$row["BrID"]."&loc=".$row["BrLoc"]."&ifsc=".$row["BrIFSC"]."\"><button onclick=\"alertdeleteFunction()\" type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DELETE PERMANENTLY</button></a>";
	}
}
else {
