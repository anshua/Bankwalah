<div class="card" style="margin-top:20px; margin-bottom:20px;">
	...
	<h3><?php echo "<a href=\"clerk-employee-view.php?id=".$ses_EmpID."\">".$ses_EmpName."</a>"; ?></h3>
	<p class="card-title"><?php echo $ses_EmpRole; ?></p>
	<p style="font-size:10px;"><?php echo "<a href=\"clerk-branch-view.php?id=".$ses_BrID."\">Branch ".$ses_BrID." (".$ses_BrLoc.")</a>"; ?></p>
</div>
