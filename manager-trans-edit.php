...
<form action=\"manager-trans-view.php\" method=\"post\" name=\"FormClock\">
...
<input type=\"submit\" name=\"submitedit\" value=\"UPDATE AND ADJUST BALANCE\"><a href=\"manager-trans-view.php?id=".$row["TrID"]."\"><button type=\"button\" class=\"btn btn-info btn-xs\" style=\"margin-left:20px;\">RETURN</button></a>
</form>";
	}
}
else {
