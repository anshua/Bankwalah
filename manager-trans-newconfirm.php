...
if (isset($_POST["TrCustID"]) && isset($_POST["TrAmount"]) && ($_POST["TrAmount"] >= -$row_newtr["CustCurrBal"])) {
	echo  "<form action=\"manager-trans-view.php\" method=\"post\" name=\"FormClock\">
...
<input type=\"submit\" name=\"submitnew\" value=\"CONFIRM\"><a href=\"manager-trans-view.php\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DISCARD AND START FRESH TRANSACTION</button></a></form>";
}
