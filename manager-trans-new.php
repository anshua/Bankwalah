...
<?php echo "<div class=\"alert alert-danger\">Fields marked with * are mandatory. Transactions of customers of only this Branch ".$ses_BrID." (".$ses_BrLoc.") will be accepted here. Others will fail.</div>"; ?>

<form action="manager-trans-newconfirm.php" method="post" name="FormClock">
...
<?php if (isset($_GET["id"]) && isset($_GET["name"]) && isset($_GET["bal"])) { echo "<a href=\"manager-trans-new.php\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">START FRESH TRANSACTION</button></a>"; } ?>
</form>
