...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "SELECT EmpID FROM employees WHERE EmpRole='Administrator' AND EmpLogin='$myusername' AND EmpPass = '$mypassword'";
	...
	if ($count == 1) {
		...
		$_SESSION["login_shaktimaan"] = $myusername;
...
<div class="card" style="margin-top:20px; margin-bottom:20px; background-color:azure; border-radius:5%;">
	<img src="img/shaktimaan.jpg" alt="Avatar" class="card-image" style="max-width:200px;">
	<h3>LOGIN PORTAL</h3>
	<p class="card-title">Bankwalah ♦ Administrator</p>
