...
<input type=\"submit\" name=\"submitedit\" value=\"UPDATE\"><a href=\"clerk-customer-view.php?id=".$row["CustID"]."\"><button type=\"button\" class=\"btn btn-info btn-xs\" style=\"margin-left:20px;\">RETURN</button></a>
</form>";
	}
}
else {
