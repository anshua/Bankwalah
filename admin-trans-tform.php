...
<form action="admin-trans-tconfirm.php" method="post" name="FormClock">
...
<?php if (isset($_GET["id"]) && isset($_GET["name"]) && isset($_GET["bal"])) { echo "<a href=\"admin-trans-tform.php\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">START FRESH TRANSFER</button></a>"; } ?>
</form>
