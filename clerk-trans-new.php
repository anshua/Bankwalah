...
<form action="clerk-trans-newconfirm.php" method="post" name="FormClock">
...
<?php if (isset($_GET["id"]) && isset($_GET["name"]) && isset($_GET["bal"])) { echo "<a href=\"clerk-trans-new.php\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">START FRESH TRANSACTION</button></a>"; } ?>
</form>
