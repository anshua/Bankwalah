...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Branch ID*</td>
		<td style=\"width:70%;\"><select type=\"text\" name=\"EmpBrID\" style=\"width:50%;\" required><option value=\"Select Branch\" disabled>Select Branch</option>".$EmpBrID."</select></td>
	</tr>
	<tr>
		<td>Role*</td>
		<td>".$EmpRole."</td>
...
<input type=\"submit\" name=\"submitedit\" value=\"UPDATE\"><a href=\"admin-employee-view.php?id=".$row["EmpID"]."\"><button type=\"button\" class=\"btn btn-info btn-xs\" style=\"margin-left:20px;\">RETURN</button></a>
</form>";
	}
}
else {
