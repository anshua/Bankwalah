...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Name*</td>
		<td style=\"width:70%;\"><a href=\"manager-customer-view.php?id=".$row["CustID"]."\">".$row["CustName"]."</a></td>
	</tr>
	<tr>
		<td>Father's Name*</td>
	...
	<tr>
		<td>Branch ID*</td>
		<td style=\"width:70%;\"><a href=\"manager-branch-view.php?id=".$row["CustBrID"]."\">".$row["CustBrID"]." (".$row["BrLoc"].")</a></td>
	</tr>
	<tr>
		<td>Account Type*</td>
...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printcustrecord')\">PRINT CUSTOMER RECORD</button><a href=\"manager-customer-edit.php?id=".$row["CustID"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">EDIT</button></a>
<a href=\"manager-customer-deleted.php?id=".$row["CustID"]."&name=".$row["CustName"]."&fname=".$row["CustFName"]."\"><button onclick=\"alertdeleteFunction()\" type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DELETE PERMANENTLY</button></a><a href=\"manager-trans-new.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">TRANSACT</button></a><a href=\"manager-trans-tform.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">TRANSFER</button></a>";
	}
}
else {
