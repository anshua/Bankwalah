...
<form action=\"manager-customer-view.php\" method=\"post\" enctype=\"multipart/form-data\">
...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Branch ID*</td>
		<td style=\"width:70%;\"><input type=\"text\" name=\"CustBrID\" value=\"".$row["CustBrID"]."\" style=\"width:50%; background-color:red;\" readonly></td>
	</tr>
	<tr>
		<td>Account Type*</td>
		<td>".$CustACType."</td>
...
<input type=\"submit\" name=\"submitedit\" value=\"UPDATE\"><a href=\"manager-customer-view.php?id=".$row["CustID"]."\"><button type=\"button\" class=\"btn btn-info btn-xs\" style=\"margin-left:20px;\">RETURN</button></a>
</form>";
	}
}
else {
