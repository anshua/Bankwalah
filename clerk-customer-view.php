...
<table class=\"table table-striped\">
	...
	<tr>
		<td>Name*</td>
		<td style=\"width:70%;\"><a href=\"clerk-customer-view.php?id=".$row["CustID"]."\">".$row["CustName"]."</a></td>
	</tr>
	<tr>
		<td>Father's Name*</td>
...
<button type=\"button\" class=\"btn btn-warning btn-xs\" onclick=\"printDiv('printcustrecord')\">PRINT CUSTOMER RECORD</button><a href=\"clerk-customer-edit.php?id=".$row["CustID"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">EDIT</button></a>
<a href=\"clerk-customer-deleted.php?id=".$row["CustID"]."&name=".$row["CustName"]."&fname=".$row["CustFName"]."\"><button onclick=\"alertdeleteFunction()\" type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">DELETE PERMANENTLY</button></a><a href=\"clerk-trans-new.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">TRANSACT</button></a><a href=\"clerk-trans-tform.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\"><button type=\"button\" class=\"btn btn-warning btn-xs\" style=\"margin-left:20px;\">TRANSFER</button></a>";
	}
}
else {
...
<table class=\"table table-striped table-bordered\">
	...
	while($row = $result_transcust->fetch_assoc()) {
		...
		echo "<tr>
				<td><a href=\"clerk-trans-view.php?id=".$row["TrID"]."\">".$row["TrID"]."</a></td>
				<td>".$row["TrDateTime"]."</td>
				<td><a href=\"clerk-customer-view.php?id=".$row["TrCustID"]."\">".$row["TrCustID"]."</a></td>
				<td><a href=\"clerk-employee-view.php?id=".$row["TrEmpID"]."\">".$row["TrEmpID"]."</a></td>
				<td>".$row["TrRemarks"]."</td>
				<td>".$row["TrAmount"]."</td>
				<td>".$finbal."</td>
			</tr>";
