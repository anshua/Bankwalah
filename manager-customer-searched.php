...
<table class=\"table table-striped table-bordered\">
	...
	while($row = $result->fetch_assoc()) {
		echo "<tr>
		<td>".$row["CustID"]."</td>
		<td><a href=\"manager-customer-view.php?id=".$row["CustID"]."\">".$row["CustName"]."</a></td>
		<td>".$row["CustFName"]."</td>
		<td>".$row["CustDOB"]."</td>
		<td>".$row["CustPhone"]."</td>
		<td>".$row["CustCurrBal"]."</td>
		<td><a href=\"manager-branch-view.php?id=".$row["CustBrID"]."\">".$row["BrLoc"]."</a></td>
		<td><a href=\"manager-trans-new.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\">Transact</a></td>
		<td><a href=\"manager-trans-tform.php?id=".$row["CustID"]."&name=".$row["CustName"]."&bal=".$row["CustCurrBal"]."\">Transfer</a></td>
	</tr>";
    }
	echo "</table></div>";
}
